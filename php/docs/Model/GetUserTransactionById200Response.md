...
**infraction** | [**\OpenAPI\Client\Model\GetUserTransactionById200ResponseAllOfInfractionInner[]**](GetUserTransactionById200ResponseAllOfInfractionInner.md) | Complete infraction history for this transaction. | [optional]
