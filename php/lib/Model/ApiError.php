...
class ApiError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'details' => '\OpenAPI\Client\Model\ApiErrorDetailsInner[]'
    ];
     ...
     * Sets error
     *
     * @param string $error HTTP status text.
     *
     * @return self
     */
     ...
     * Sets request_id
     *
     * @param string $request_id Unique request correlation ID (cuid). Include it when contacting support.
     *
     * @return self
     */
     ...
     * Sets error_code
     *
     * @param string|null $error_code Stable machine-readable error code, when available.
     *
     * @return self
     */
     ...
     *
     * @param int|null $retry_after_seconds Seconds to wait before retrying. Present only on 429 responses.
     *
     * @return self
     */
     ...
     * Gets details
     *
     * @return \OpenAPI\Client\Model\ApiErrorDetailsInner[]|null
     */
     ...
     * Sets details
     *
     * @param \OpenAPI\Client\Model\ApiErrorDetailsInner[]|null $details Field-level validation errors, when applicable.
     *
     * @return self
     */
