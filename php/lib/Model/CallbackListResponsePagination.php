...
/**
 * CallbackListResponsePagination Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CallbackListResponsePagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CallbackListResponse_pagination';
     ...
     * Sets has_next_page
     *
     * @param bool|null $has_next_page Indicates if there is a next page
     *
     * @return self
     */
