...
/**
 * GetUserTransactionById200ResponseAllOfCallbackLogInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetUserTransactionById200ResponseAllOfCallbackLogInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'get_user_transaction_by_id_200_response_allOf_CallbackLog_inner';
     ...
     * Sets status
     *
     * @param int|null $status HTTP status code returned by the receiver
     *
     * @return self
     */
     ...
     * Sets response_time
     *
     * @param float|null $response_time Round-trip time in ms
     *
     * @return self
     */
