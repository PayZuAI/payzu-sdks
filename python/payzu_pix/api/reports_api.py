...
class ReportsApi:
    ...
    def get_user_transactions(
        ...
        status: Annotated[Optional[StrictStr], Field(description="Transaction status. Accepts CSV: PENDING,COMPLETED,etc.")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Transaction type. Accepts CSV: DEPOSIT,WITHDRAW,COMMISSION.")] = None,
        method: Annotated[Optional[StrictStr], Field(description="Transaction method/rail. Accepts CSV: PIX,BANK_SLIP,INTERNAL_TRANSFER.")] = None,
        amount: Annotated[Optional[Union[Annotated[float, Field(strict=True, ge=0.01)], Annotated[int, Field(strict=True, ge=1)]]], Field(description="Amount filter. Minimum 0.01.")] = None,
        document: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="CPF (11 digits) or CNPJ (14 digits), digits only, no punctuation.")] = None,
        ...
        :type id: str
        :param status: Transaction status. Accepts CSV: PENDING,COMPLETED,etc.
        :type status: str
        :param type: Transaction type. Accepts CSV: DEPOSIT,WITHDRAW,COMMISSION.
        :type type: str
        :param method: Transaction method/rail. Accepts CSV: PIX,BANK_SLIP,INTERNAL_TRANSFER.
        :type method: str
        :param amount: Amount filter. Minimum 0.01.
        :type amount: float
        :param document: CPF (11 digits) or CNPJ (14 digits), digits only, no punctuation.
        :type document: str
    ...
    def list_user_reports(
        ...
        created_at_from: Annotated[Optional[datetime], Field(description="Filter: created from.")] = None,
        created_at_to: Annotated[Optional[datetime], Field(description="Filter: created up to.")] = None,
        updated_at_from: Annotated[Optional[datetime], Field(description="Filter: updated from.")] = None,
        updated_at_to: Annotated[Optional[datetime], Field(description="Filter: updated up to.")] = None,
        ...
        :param status:
        :type status: str
        :param created_at_from: Filter: created from.
        :type created_at_from: datetime
        :param created_at_to: Filter: created up to.
        :type created_at_to: datetime
        :param updated_at_from: Filter: updated from.
        :type updated_at_from: datetime
        :param updated_at_to: Filter: updated up to.
