...
class CallbackListResponse(BaseModel):
    ...
    """ # noqa: E501
    pagination: Optional[CallbackListResponsePagination] = None
    callbacks: Optional[List[CallbackDetail]] = Field(default=None, description="Array of callback logs")
    __properties: ClassVar[List[str]] = ["pagination", "callbacks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pagination": CallbackListResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None,
            "callbacks": [CallbackDetail.from_dict(_item) for _item in obj["callbacks"]] if obj.get("callbacks") is not None else None
        })
        return _obj
