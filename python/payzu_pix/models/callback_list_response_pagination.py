...
class CallbackListResponsePagination(BaseModel):
    """
    ...
    has_next_page: Optional[StrictBool] = Field(default=None, description="Indicates if there is a next page", alias="hasNextPage")
    __properties: ClassVar[List[str]] = ["page", "limit", "hasNextPage"]
