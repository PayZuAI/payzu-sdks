...
class DepositPendingListResponse(BaseModel):
    """
    ...
    data: Optional[List[DepositPending]] = None
    __properties: ClassVar[List[str]] = ["page", "limit", "hasNextPage", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [DepositPending.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
