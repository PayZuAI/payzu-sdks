...
class ReportJob(BaseModel):
    ...
    expires_at: Optional[datetime] = Field(default=None, description="When the file expires from storage (typically 7 days after creation)", alias="expiresAt")
    __properties: ClassVar[List[str]] = ["id", "status", "createdAt", "updatedAt", "expiresAt"]
