...
class SentWebhookDetail(BaseModel):
    """
    SentWebhookDetail
    """ # noqa: E501
    ...
    status: Optional[StrictInt] = Field(default=None, description="HTTP status returned by your endpoint.")
    ...
    response_time: Optional[StrictInt] = Field(default=None, description="Response time of your endpoint, in milliseconds.", alias="responseTime")
    event_type: Optional[StrictStr] = Field(default=None, alias="eventType")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "webhookId", "userId", "transactionId", "url", "body", "status", "responseHeaders", "responseBody", "error", "responseTime", "eventType", "createdAt"]
