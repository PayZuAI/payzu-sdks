...
class WebhookWithSecret(BaseModel):
    ...
    secret: Optional[StrictStr] = Field(default=None, description="HMAC signing secret. Shown only on creation and on rotate-secret. Store it now.")
    __properties: ClassVar[List[str]] = ["id", "url", "active", "events", "hasSecret", "createdAt", "updatedAt", "secret"]
