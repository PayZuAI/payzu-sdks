...
class TestPostPixRequest(unittest.TestCase):
    """PostPixRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostPixRequest:
        """Test PostPixRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostPixRequest`
        """
        model = PostPixRequest()
        if include_optional:
            return PostPixRequest(
                amount = 10.9,
